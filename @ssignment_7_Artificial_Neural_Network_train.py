...
dataframe.iloc[:, 8] = scale(dataframe.iloc[:, 8], from_interval=(-75, 75), to_interval=(0,1))
dataframe.iloc[:, 9:] = scale(dataframe.iloc[:, 9:], from_interval=(-25,25), to_interval=(0,1))
...
# 5. train ANN model
history = model.fit(x, y, batch_size=100, epochs=1000, shuffle=True)
