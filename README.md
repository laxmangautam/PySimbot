...
- Python3: The supported versions currently are [3.6-3.9](https://www.python.org/downloads/)
- (Optional) Virtualenv: To create the isolated Python environments. See more on [Virtualenv](https://virtualenv.pypa.io/en/latest/)
- Pip: The package installer for Python.
- Libraries, use the program such as cmd, powershell, or terminal. The command will be based on your OS.
...
- You can see the messages in the command window while running an example. It shows the simulation logs.
...
We can control the robot by the WASD keys and see how it moves on the map.
